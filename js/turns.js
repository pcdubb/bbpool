...
var query = firebase.database().ref('draftOrder').child('draftOrder2020').orderByKey();
var queryTeams = firebase.database().ref("2020selections").orderByKey();
...
function makeHtmlListForPage(){
    var currentPick = 0;
    var ref = firebase.database().ref("2020selections");
        ref.once("value")
        .then(function(snapshot) {
